...
namespace FMOD
{
    ...
    */
    ...
    {
        public const int    number = 0x00010301;
#if WIN64
    ...
    */
    public class Channel
    {
        ...
        {
            return FMOD_Channel_SetReverbProperties(channelraw, instance, wet);
        }
        public RESULT getReverbProperties   (int instance, ref float wet)
        {
            return FMOD_Channel_GetReverbProperties(channelraw, instance, ref wet);
        }
        ...
        public RESULT addDSP                (DSP dsp, CHANNELCONTROL_DSP_INDEX index, ref DSPConnection connection)
        {
            ...
            try
            {
                result = FMOD_Channel_AddDSP(channelraw, index, dsp.getRaw(), ref dspconnectionraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        [DllImport (VERSION.dll)]
        private static extern RESULT FMOD_Channel_GetReverbProperties   (IntPtr channel, int instance, ref float wet);
        [DllImport (VERSION.dll)]
        ...
        [DllImport (VERSION.dll)]
        private static extern RESULT FMOD_Channel_AddDSP                (IntPtr channel, CHANNELCONTROL_DSP_INDEX index, IntPtr dsp, ref IntPtr connection);
        [DllImport (VERSION.dll)]
