...
//=======================================================================
//GameWin constructor
GameWin::GameWin ( GameUI& gameUI, DxKeyboard& keyboard, DxController& controller )
...
bool GameWin::init ( Game* window )
{
   myBGSprite.create( "GAMEWIN", 10 );
...
//=======================================================================
//Resets GameWin
void GameWin::reset ( Game* window )
{
   shutdown( window );
   init( window );
}
...
//=======================================================================
//Shuts down GameWin by destroying text and sprites

void GameWin::shutdown ( Game* window )
{
   myBGSprite.destroy();
   myHSSprite.destroy();
...
bool GameWin::checkIfHighScore ( int playerScore )
{
